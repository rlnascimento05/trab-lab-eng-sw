...
ALTER TABLE Pedido      ADD CONSTRAINT fk_Pedido        FOREIGN KEY (codproduto)  REFERENCES codproduto(Produto);
ALTER TABLE Medicamento ADD CONSTRAINT fk_Medicamento   FOREIGN KEY (codproduto)  REFERENCES codproduto(Produto);
ALTER TABLE Cosmeticos  ADD CONSTRAINT fk_Cosmeticos    FOREIGN KEY (codproduto)  REFERENCES codproduto(Produto);
